...
VidSpec invokes FFmpeg on user-selected media files. Use current FFmpeg releases and do not analyze
...
VidSpec does not upload videos or run a semantic provider by default. Selecting
