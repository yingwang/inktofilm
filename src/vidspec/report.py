...
def _finding_row(finding: Finding) -> str:
    ...
    return """<tr>
      ...
      <td><strong>{check}</strong><small>{summary}</small></td>
...
<title>{suite} · VidSpec report</title><style>{style}</style></head>
<body><main class="shell">
  <section class="hero"><div><span class="brand">VIDSPEC / RUN REPORT</span><h1>{suite}</h1>
  ...
  <footer>Generated by VidSpec · deterministic video tests, inspectable evidence</footer>
